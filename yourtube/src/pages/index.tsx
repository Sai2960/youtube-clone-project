...
>
  ...
  {/* Play Icon Overlay - FIXED FOR BOTH THEMES */}
  <div className="absolute inset-0 flex items-center justify-center opacity-0 lg:group-hover/thumbnail:opacity-100 transition-all duration-200 bg-black/40 dark:bg-black/50 pointer-events-none">
    <div className="bg-white dark:bg-white/95 backdrop-blur-sm rounded-full p-3 lg:p-4 shadow-xl transform scale-90 lg:group-hover/thumbnail:scale-100 transition-transform duration-200">
