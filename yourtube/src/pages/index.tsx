...
/* ===== COMPREHENSIVE TEXT DISPLAY FIXES ===== */

/* ===== SHORTS TITLE STYLING ===== */
.shorts-title {
  display: -webkit-box;
  -webkit-line-clamp: 2;
...
/* ===== TEXT CONTAINER FIX (Critical for Flex Overflow) ===== */
.flex-1 {
  min-w-0;
}
