// src/pages/login.tsx - PREMIUM PROFESSIONAL VERSION - FULLY FIXED
...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      {/* ✅ FIXED: Premium Background with proper mobile support */}
      <div className="fixed inset-0 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-[#0a0a0a] dark:via-[#0f0f23] dark:to-[#1a1a2e]">
        ...
        {/* ✅ FIXED: Content Container with proper scrolling */}
