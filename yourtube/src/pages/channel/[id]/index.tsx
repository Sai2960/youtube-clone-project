              ...
              <div className="w-full overflow-hidden px-2 sm:px-0">
                {shortsLoading ? (
                  ...
                  <div>
                    ...
                    {/* Shorts Grid */}
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-1.5 sm:gap-3 w-full max-w-full">
                      {" "}
                      {shorts.map((short) => {
                        ...
                        return (
                          ...
                          >
                            {/* Thumbnail Container */}
                            <div className="relative w-full rounded-lg sm:rounded-xl overflow-hidden bg-black shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-red-500 dark:hover:border-red-500">
                              {" "}
                              <div
