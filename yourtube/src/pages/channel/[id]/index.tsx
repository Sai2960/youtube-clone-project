...
const getShortThumbnail = (short: any): string => {
  ...
  for (const thumb of thumbnailCandidates) {
    if (thumb && typeof thumb === 'string' && thumb.includes('res.cloudinary.com')) {
      // Clean the URL
  ...
  if (short.videoUrl && short.videoUrl.includes('res.cloudinary.com')) {
    try {
      ...
      // Extract public_id
      const match = cleanVideoUrl.match(/youtube-clone\/shorts\/videos\/([^.\/]+)/);
      ...
      if (match) {
        ...
        console.log('✅ Generated thumbnail:', generatedThumbnail.substring(0, 80));
                ...
                <div className="relative w-full rounded-xl sm:rounded-2xl overflow-hidden bg-black shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-red-500 dark:hover:border-red-500">
                  ...
                  <div className="relative w-full" style={{ paddingBottom: '177.78%' }}>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        if (short.videoUrl && short.videoUrl.includes('cloudinary.com')) {
                          ...
                          if (match) {
                            ...
                            console.log('🔄 Retrying with:', retry.substring(0, 80));
                            target.src = retry;
                            return;
                          }
                        }
                      ...
                      onLoad={() => {
                        console.log('✅ Thumbnail loaded for:', short._id);
                      }}
                    />
