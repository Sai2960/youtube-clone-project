...
<div className="py-2 px-4 space-y-2">
  ...
  <button
    ...
    className={`w-full px-3 py-3 flex items-center gap-3 rounded-xl transition-all ${
      notificationPreference === "all"
        ? "bg-blue-50 dark:bg-blue-500/10 ring-1 ring-blue-500 dark:ring-blue-400"
        : "bg-gray-50 dark:bg-neutral-800/50 active:bg-gray-200 dark:active:bg-neutral-700"
    } ${
...
<div className="border-t border-gray-200 dark:border-neutral-700/50 px-4 py-3">
  <button
    ...
    className="w-full py-2.5 px-4 text-center text-red-600 dark:text-red-400 font-semibold text-[14px] rounded-xl bg-red-50 dark:bg-red-500/10 active:bg-red-200 dark:active:bg-red-500/25 transition-all"
  >
    Unsubscribe
  </button>
</div>
