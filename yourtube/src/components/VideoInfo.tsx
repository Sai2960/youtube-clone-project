...
{isSubscribed && (
  <button
    ...
    className="h-9 w-9 min-h-[36px] min-w-[36px] rounded-full bg-gray-200 dark:bg-neutral-700 hover:bg-gray-300 dark:hover:bg-neutral-600 transition-all inline-flex items-center justify-center flex-shrink-0 border border-gray-300 dark:border-neutral-600"
