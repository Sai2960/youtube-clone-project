                        ...
                        return (
                          <Link key={item._id} href={`/shorts/${short._id}`}>
                            <div className="flex-shrink-0 group cursor-pointer w-[160px] md:w-[180px]">
                              ...
                              <div className="short-thumbnail-container aspect-[9/16] rounded-xl overflow-hidden relative bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600">
                            ...
                            <div key={item._id} className="mb-2 md:mb-3">
                              <div className="flex gap-2 md:gap-3 hover:bg-gray-50 dark:hover:bg-[#272727] p-2 rounded-lg transition-colors relative group">
                                ...
                                >
                                  ...
                                  <div className="video-thumbnail-container w-[140px] h-[78px] md:w-[246px] md:h-[138px] bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden relative border border-gray-300 dark:border-gray-600">
                                    <video
