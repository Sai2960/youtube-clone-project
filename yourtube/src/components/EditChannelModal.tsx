// src/components/EditChannelModal.tsx - FULLY OPTIMIZED VERSION
      ...
      >
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex-shrink-0">
          <button
            ...
            className={`flex-1 py-3 sm:py-4 px-2 sm:px-4 text-xs sm:text-sm font-semibold transition-all relative ${
              activeTab === "avatar"
                ...
                <div className="pb-3">
                  ...
                  {!previewUrl ? (
                    <div
                      ...
                      className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-6 sm:p-10 text-center cursor-pointer hover:border-blue-500 dark:hover:border-blue-400 transition-all bg-gray-50 dark:bg-gray-800/50 hover:bg-blue-50 dark:hover:bg-blue-900/10 group"
                    >
                      <div className="w-10 h-10 sm:w-14 sm:h-14 mx-auto mb-2 sm:mb-3 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                        <Upload className="w-5 h-5 sm:w-7 sm:h-7 text-blue-600 dark:text-blue-400" />
                      </div>
        ...
        {/* ========================================== */}
        <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-3 sm:p-4 md:p-5 flex-shrink-0">
          {(activeTab === "avatar" || activeTab === "banner") ? (
            // IMAGE UPLOAD FOOTER
            <div className="flex gap-2 sm:gap-3">
              <button
                onClick={onClose}
                disabled={uploading}
                className="flex-1 px-4 sm:px-6 py-2 sm:py-2.5 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white text-sm sm:text-base font-semibold rounded-lg sm:rounded-xl transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 px-4 sm:px-6 py-2 sm:py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white text-sm sm:text-base font-semibold rounded-lg sm:rounded-xl transition flex items-center justify-center gap-2 shadow-lg hover:shadow-xl disabled:shadow-none disabled:cursor-not-allowed"
              >
                {uploading ? (
                  <>
            ...
            <div className="flex justify-end gap-2 sm:gap-3">
              ...
              <Button
                ...
                className="bg-blue-600 hover:bg-blue-700 h-10 sm:h-12 px-4 sm:px-6 text-sm sm:text-base"
              >
                {isSubmitting ? (
                  <>
