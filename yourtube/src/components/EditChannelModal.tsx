// src/components/EditChannelModal.tsx - COMPLETE FIXED VERSION WITH PROPER SCROLLING
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-3xl flex flex-col max-h-[95vh]">
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex-shrink-0">
          <button
            ...
            className={`flex-1 py-3 sm:py-4 px-3 sm:px-4 text-xs sm:text-sm font-semibold transition-all relative ${
              activeTab === "avatar"
        ...
        {/* ========================================== */}
        {/* SCROLLABLE CONTENT AREA - PROPER HEIGHT */}
        {/* ========================================== */}
                ...
                <div>
                  ...
                  {!previewUrl ? (
                    <div
                      ...
                      className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl p-6 sm:p-8 md:p-12 text-center cursor-pointer hover:border-blue-500 dark:hover:border-blue-400 transition-all bg-gray-50 dark:bg-gray-800/50 hover:bg-blue-50 dark:hover:bg-blue-900/10 group min-h-[180px] sm:min-h-[200px] flex flex-col items-center justify-center"
                    >
                      <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 mx-auto mb-2 sm:mb-3 md:mb-4 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                        <Upload className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-blue-600 dark:text-blue-400" />
                      </div>
                      <p className="text-gray-900 dark:text-white font-semibold text-sm sm:text-base md:text-lg mb-1">
            ...
            {activeTab === "info" && (
              <div className="space-y-4 sm:space-y-5">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg sm:rounded-xl p-3 sm:p-4">
                  <div className="flex items-start gap-2 sm:gap-3">
                    <div className="bg-blue-100 dark:bg-blue-900/50 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                      <Edit2 className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-blue-400" />
                    </div>
                    <div>
                      <h3 className="text-sm sm:text-base font-semibold text-blue-900 dark:text-blue-100 mb-1">
                      ...
                      <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-300 leading-relaxed">
                        Make your channel stand out with a unique name and
