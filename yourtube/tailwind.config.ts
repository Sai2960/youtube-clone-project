  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "dislike-bounce":
          "dislike-bounce 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)",

        // ═══════════════════════════════════════
        // LIKE/DISLIKE ANIMATIONS - MOBILE
        // ═══════════════════════════════════════
        "like-bounce-mobile":
          "like-bounce-mobile 0.65s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "dislike-bounce-mobile":
          "dislike-bounce-mobile 0.65s cubic-bezier(0.34, 1.56, 0.64, 1)",
